                ...
                Positioned(
                  ...
                  child: FadeAnimation(1, Container(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        FadeAnimation(1.3, Text("Popular Qoute", style: TextStyle(color: Colors.white, fontSize: 50, fontWeight: FontWeight.bold),)),
                        SizedBox(height: 25,),
                        FadeAnimation(1.4, Text(".", style: TextStyle(color: Colors.white, fontSize: 20),)),
                        SizedBox(height: 10,),
                        // Row(
                        //   children: <Widget>[
                        ...
                        FadeAnimation(1.5, Container(
                          ...
                          child: Center(
                            child: Text('Save to Download', style: TextStyle(fontWeight: FontWeight.bold),)
                          ),
                        )),
                        SizedBox(height: 30,),
                      ],
